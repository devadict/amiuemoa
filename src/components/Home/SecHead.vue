      ...
      <div class="col">
        <div class="card mb-4">
          <div class="card-body text-center p-4">
            ...
            <p>Non vulputate feugiat semper.</p>
            <a class="btn btn-light d-block w-100" role="button" href="#"
              >Button</a
            >
          </div>
        </div>
        <div class="bg-light border rounded border-light p-4">
          <ul class="list-unstyled">
            <li class="d-flex mb-2">
              <span
                class="bs-icon-xs bs-icon-rounded bs-icon-primary-light bs-icon me-2"
                ><svg
        ...
        <div class="card border-primary border-2 mb-4">
          <div class="card-body text-center p-4">
            ...
            <h4 class="display-5 fw-bold card-title">
              $38<span class="fs-4 fw-normal text-muted">/mo</span>
            </h4>
            <p>Varius rutrum duis vel.</p>
            <a class="btn btn-primary d-block w-100" role="button" href="#"
              >Button</a
            >
          </div>
        </div>
      ...
      <div class="col">
        <div class="card mb-4">
          <div class="card-body text-center p-4">
            ...
            <h4 class="display-5 fw-bold card-title">
              $70<span class="fs-4 fw-normal text-muted">/mo</span>
            </h4>
            <p>Et lacinia fringilla massa.</p>
            <a class="btn btn-dark d-block w-100" role="button" href="#"
              >Button</a
            >
          </div>
        </div>
